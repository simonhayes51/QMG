  ...
  return (
    <section className="container-pad py-12">
      ...
      <p className="opacity-80 mt-1">
        Tell us about your venue or event and we'll get back to you.
      </p>
      ...
      {hasFormspree ? (
        ...
        <div className="mt-6 glass p-6 max-w-xl">
          <p className="opacity-80">
            Email isn’t wired yet. Click below to email us directly and we’ll reply fast.
          </p>
          <a className="btn btn-primary mt-4 inline-flex" href="mailto:hello@thequizmastergeneral.com?subject=Booking%20enquiry">
            Email Us
          </a>
          <p className="text-xs opacity-60 mt-4">
            (To enable the form, set <code>NEXT_PUBLIC_FORMSPREE_ID</code> and rebuild.)
          </p>
        </div>
      )}
    </section>
